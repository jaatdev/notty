...
export default function TopicPageClient({ subject, topic, slug, topicId, colors, theme }: TopicPageClientProps) {
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 md:px-6 py-12 md:py-16">
          ...
          >
            <ol className="flex items-center gap-2 text-sm flex-wrap">
              ...
              <li>
                <Link href={`/subjects/${slug}`} className="text-white/70 hover:text-white transition-colors font-medium">
                  {subject.emoji} {subject.title}
                </Link>
              </li>
              <li className="text-white/50">/</li>
              <li className="text-white font-bold">{topic.title}</li>
            </ol>
          </motion.nav>
